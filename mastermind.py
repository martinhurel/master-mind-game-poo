...
class SecondMenu:
    ...
    def update(self):
        ...
        draw_text('MASTERMIND', game_font, (255, 255, 255), self.screen, 250, 20)
        draw_text('Let\'s play', smallfont, (255, 255, 255), self.screen, 350, 507)
        ...
        draw_text('-', medium_font, (255, 255, 255), self.screen, 350, 425)
        draw_text('+', medium_font, (255, 255, 255), self.screen, 450, 425)
    ...
    def handleGameEvent(self, mouse_pos, event):
        game_font = pygame.font.Font('mm_font.ttf',100)
        smallfont = pygame.font.SysFont('Corbel',35)
        matching_play_x = (350 - 50 <= mouse_pos[0] <= 350 + 100)
        matching_play_y = (507 <= mouse_pos[1] <= 507 + 40)

        matching_plus_x = (450 <= mouse_pos[0] <= 450 + 100)
        matching_plus_y = (425 <= mouse_pos[1] <= 425 + 40)

        matching_less_x = (350 <= mouse_pos[0] <= 350 + 50)
        matching_less_y = (425<= mouse_pos[1] <= 425 + 40)
        ...
        if matching_plus_x & matching_plus_y:
            if self.difficulty < 10:
                self.difficulty += 1

        if matching_less_x & matching_less_y:
